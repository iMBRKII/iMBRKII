# 💫 About Me:
👨‍💻 Software Engineering student Passionate about building clean, tested, and maintainable code.<br><br>✅ Experienced in:<br>Java (Advanced) – with unit testing using JUnit<br>C++, Python, and front-end basics (HTML, CSS, JavaScript)<br>MySQL and database design using ERD, normalization, and relationships<br>Git and Linux, with strong command-line experience<br>🎨 UI/UX Design using Figma<br>🛠 Currently improving my web development and DevOps skills<br><br>🚀 I'm motivated to learn, collaborate, and solve real-world problems through code. Check out my repositories! 
